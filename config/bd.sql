...
ALTER TABLE productos ADD FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario) ON DELETE CASCADE;
ALTER TABLE producto_categoria ADD FOREIGN KEY (id_producto) REFERENCES productos(id_producto) ON DELETE CASCADE;
ALTER TABLE producto_categoria ADD FOREIGN KEY (id_categoria) REFERENCES categorias(id_categoria) ON DELETE CASCADE;
ALTER TABLE carrito ADD FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario) ON DELETE CASCADE;
ALTER TABLE carrito ADD FOREIGN KEY (id_producto) REFERENCES productos(id_producto) ON DELETE CASCADE;
ALTER TABLE ordenes ADD FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario) ON DELETE CASCADE;
ALTER TABLE detalle_orden ADD FOREIGN KEY (id_orden) REFERENCES ordenes(id_orden) ON DELETE CASCADE;
ALTER TABLE detalle_orden ADD FOREIGN KEY (id_producto) REFERENCES productos(id_producto) ON DELETE CASCADE;
...
ADD id_publico INT,
ADD descuento TINYINT CHECK (descuento BETWEEN 1 AND 50),
...
-- CLAVES FORÁNEAS
-- =========================================
ALTER TABLE productos ADD FOREIGN KEY (id_publico) REFERENCES publicos(id_publico) ON DELETE SET NULL;
ALTER TABLE productos ADD FOREIGN KEY (id_categoria) REFERENCES categorias(id_categoria) ON DELETE SET NULL;